...
| 个项 | 数组[任意类型：link:#managedCluster_1_3_get_response_body["managedCluster_1.3_get_response_body"]，数组[]] | True  a| 
...
|===
[[managedCluster_1_3_get_response_body]]
[role="api-collapsible-fifth-title"]
managedCluster_1.3_get_response_body
